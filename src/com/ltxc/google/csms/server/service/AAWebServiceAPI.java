...
public class AAWebServiceAPI {
	...
	private static Logger logger = Logger
			.getLogger(AAWebServiceAPI.class.getName());
	...
	public AAWebServiceAPI() throws Exception
	{
	...
	public AAWebServiceAPI(String url, String username, String password, String profile) throws Exception
	{
		_proxy = getProxy(url);
		_pattern = Pattern.compile(SharedConstants.Pattern_SessionID);
		_user = username;
